...
class LoginService:
    ...
    def _login(self, username, password) -> str:
        ...
        lt_value = html.unescape(re.search('value="(.*?)"', html_lt_group).group(1))
        ...
        while is_ready == False:
            ...
            # While redirection, follow redirect, until redirection starts with our needed URL (stedgeai-dc.st.com)
            if status_code == 302:
                redirect = resp.headers['Location']
