...
The [application code](../../application_code/instance_segmentation/STM32N6/README_ModelZoo.md) runs with:
...
As an example, we will show how to deploy [yolov8n_256_quant_pc_uf_seg_coco-st.tflite](https://github.com/STMicroelectronics/stm32ai-modelzoo/tree/master/instance_segmentation/yolov8n_seg) pre-trained on the COCO person dataset using the necessary parameters provided in [yolov8n_seg_256_config.yaml](https://github.com/STMicroelectronics/stm32ai-modelzoo/blob/master/instance_segmentation/yolov8n_seg/yolov8n_seg_256_config.yaml). To get this model, download it from the [ST Ultralytics fork](https://github.com/stm32-hotspot/ultralytics/blob/main/examples/YOLOv8-STEdgeAI/stedgeai_models/segmentation/yolov8n_256_quant_pc_uf_seg_coco-st.tflite) and put it in the corresponding ModelZoo folder (`instance_segmentation/yolov8n_seg/`).
...
- `deployment`
  ...
  - `serie` - __STM32N6__
  - `board` - __STM32N6570-DK__, see the [README](../../application_code/instance_segmentation/STM32N6/README.md) for more details.
