...
def data_augmentation(images, gt_labels, config=None, pixels_range=None, batch_info=None):
    ...
    Inputs:
        ...
        pixels_range:
            range of values of pixels in the input images, tuple of length 2
    """  
    ...
    for fn, args in config.items():             
        if fn == 'random_contrast':
            ...
            default = {'crop_center_x': (0.25, 0.75),
                       ...
                       'change_rate': 0.9}
            args = get_arg_values(args, default, fn)
            images, gt_labels = segm_random_misc.segm_random_crop(
                            images,
                            gt_labels,
            ...
            args = get_arg_values(args, default, fn)
            images, gt_labels = segm_random_affine.segm_random_flip(
                            images,
                            gt_labels,
                            mode=args.mode,
                            change_rate=args.change_rate)
            ...
            default = {'width_factor': None, 'height_factor': None,
                       ...
                       'change_rate': 1.0} 
            args = get_arg_values(args, default, fn)
            images, gt_labels = segm_random_affine.segm_random_translation(
                            images,
                            gt_labels,
            ...
            default = {'factor': None,
                       ...
                       'change_rate': 1.0} 
            args = get_arg_values(args, default, fn)
            images, gt_labels = segm_random_affine.segm_random_rotation(
                            images,
                            gt_labels,
                            factor=args.factor,
                            fill_mode=args.fill_mode,
            ...
            images, gt_labels = segm_random_affine.segm_random_shear(
                            images,
                            gt_labels,
                            factor=args.factor,
                            axis=axis,
            ...
            default = {'width_factor': None, 'height_factor': None,
                       ...
                       'change_rate': 1.0} 
            args = get_arg_values(args, default, fn)
            images, gt_labels = segm_random_affine.segm_random_zoom(
                            images,
                            gt_labels,
                            width_factor=args.width_factor,
                            height_factor=args.height_factor,
        ...
        # elif fn == 'random_periodic_resizing':
            ...
            # args = get_arg_values(args, default, fn)
            # images, gt_labels = segm_random_misc.segm_random_periodic_resizing(
                            # images,
                            # gt_labels,
                            # period=args.period,
                            ...
                            # interpolation=args.interpolation,
                            # batch=batch_info[0],
                            # last_image_size=(batch_info[1], batch_info[2]))
