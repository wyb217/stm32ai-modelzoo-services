...
def st_ssd_mobilenet_v1(
    ...
    sizes, ratios = get_sizes_ratios_ssd_v1(input_shape)
    ...
    if input_shape[0] == 192:
        ...
        return Model(inputs=base_model.input, outputs=[cls_softmax, bbox_preds, anchors], name="st_ssd_mobilenet_v1")
        ...
        return Model(inputs=base_model.input, outputs=[cls_softmax, bbox_preds, anchors],
                     name="st_ssd_mobilenet_v1")
