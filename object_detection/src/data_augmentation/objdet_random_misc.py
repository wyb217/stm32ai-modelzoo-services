...
def objdet_random_periodic_resizing(
    ...
    def resize_images():
        ...
        gt_boxes = bbox_center_to_corners_coords(gt_boxes, image_size=target_size, normalize=False)
    ...
    images, gt_labels = tf.cond(tf.reduce_any(tf.not_equal(target_size, input_image_size)),
                                resize_images, keep_original_size)
